...
#list op maps
maps_4v4 = ['Essen Steelworks','Hill 400','La Gleize','Steppes','City 17','General Mud','Red Ball Express','Whiteball Express','Lanzerath Ambush','Lienne Forest','Lorch Assault','Nordwind','Port of Hamburg','Road to Arnhem','Vielsam','Ettelbruck Station 8P by RickieRilfe']
...
def fill_in_allied(amountplayers):
    ...
    def button_command_allied():
        ...
        TeamResults_Premade_allied(Namelist_allied,AlliedFactions_premade,Alliedcommanders_premade, Map_list_inhouse_4v4_premade)
...
Ettelbruck_station = tk.PhotoImage(file=str(cwd)+ '\\Images\\4v4 maps\\Ettelbruck station.png', name='Ettelbruck station')
...
def TeamResults(AxisPlayers,AlliedPlayers,AxisFactions,AlliedFactions,Axiscommanders,Alliedcommanders,Map_list_inhouse_4v4):#,Map_list_inhouse_3v3,Map_list_inhouse_2v2,Map_list_inhouse_1v1):
    ...
    elif Map_list_inhouse_4v4[0] == 'Ettelbruck Station 8P by RickieRilfe':
                canvas.create_image(map_x,map_y, image=Ettelbruck_station , anchor = NW , tag="Ettelbruck_station ")
...
def TeamResults_Premade_allied(Namelist_allied,AlliedFactions_premade,Alliedcommanders_premade, Map_list_inhouse_4v4_premade):
    ...
    if Map_list_inhouse_4v4_premade[0] == 'City 17':
                ...
                canvas.create_image(map_x,map_y, image=Essen_steelworks, anchor = NW , tag="Essen_steelworks")
    elif Map_list_inhouse_4v4_premade[0] == 'Ettelbruck Station 8P by RickieRilfe':
                canvas.create_image(map_x,map_y, image=Ettelbruck_station , anchor = NW , tag="Ettelbruck_station ")
